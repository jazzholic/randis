...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Laporan Rekapitulasi Perawatan Kendaraan dan BBM</title>
        <style type="text/css">
...
<h3 style="text-align: center;padding-bottom: 5px;">REKAPITULASI PERAWATAN KENDARAAN DAN BBM<br><?=$instansi['nama_instansi']?></h3>
<div class="table">
<table style="border-spacing: 0;border-collapse: collapse; width: 100%;">
            <thead>
                <tr style="color:#ccc">
                    ...
                    <th style="vertical-align:middle;text-align:center">REKANAN</th>
                    <th style="vertical-align:middle;text-align:center">JENIS BBM</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center"><?=$key['rekanan']?></td>
                    <td style="text-align:center"><?=$key['jenis_bbm']?></td>
