...
$this->title = 'Laporan Pajak Kendaraan';
...
<div class="box box-info setting-update">
    <div class="box-header with-border">
        ...
        <div class="box-tolls pull-right">
            ...
            ?>
            <?=Html::a('<i class="fa fa-file-excel-o"></i> Export PDF', ['laporan/pajakpdf', 'params'=>$model],['title'=> 'Export Ke PDF','class'=>'btn btn-danger btn-box-tool','target' => '_blank','style'=>'color:#fff'])?>
            <?php }?>
        </div>
    </div>
    <div class="box-body">
        ...
        <table class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th style="vertical-align:middle;text-align:center" rowspan="2">TANGGAL BAYAR</th>
                    <th style="vertical-align:middle;text-align:center" rowspan="2">JUMLAH BAYAR</th>
                    <th style="vertical-align:middle;text-align:center" rowspan="2">TANGGAL EXPIRED</th>
                    <th style="vertical-align:middle;" rowspan="2">NAMA PEMEGANG</th>
                </tr>
            </thead>
            <tbody>
                <?php
