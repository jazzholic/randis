        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
                ...
                if(isset($model->type_id)){
                    $type = ArrayHelper::map(\common\models\Type::find()->where(['id_type'=>$model->type_id])->asArray()->all(), 'id_type', 'nama_type');
                }else{
                    $type = [];
                }
                ?>
            ...
            <div class="tab-pane" id="tab_2">
                ...
                <?= BaseHtml::activeHiddenInput($model, 'nomor_polisi_lama'); ?>
                <?= BaseHtml::activeHiddenInput($model, 'pemegang_lama'); ?>
                <?= BaseHtml::activeHiddenInput($model, 'instansi_lama'); ?>
