...
use common\models\RiwayatPajakSearch;
...
/**
 * PajakController implements the CRUD actions for RiwayatPajak model.
 */
class PajakController extends Controller
{
    ...
    /**
     * Lists all RiwayatPajak models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new RiwayatPajakSearch();
        ...
        $searchModel->kendaraan_id = $model['id_kendaraan'];
    ...
    /**
     * Displays a single RiwayatPajak model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RiwayatPajak model.
    ...
    public function actionCreate()
    {
        ...
        $kendaraan = \common\models\Kendaraan::find()->where(['pemegang_id'=>$pemegang['id_pemegang']])->one();

        $model->kendaraan_id = $kendaraan['id_kendaraan'];
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> 'Tambah Riwayat Pajak',
                    'content'=>'<span class="text-success">Data Riwayat Pajak Berhasil Ditambahkan</span>',
                    'footer'=> Html::button('<i class="fa fa-close" aria-hidden="true"></i> Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing RiwayatPajak model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing RiwayatPajak model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RiwayatPajak model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the RiwayatPajak model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RiwayatPajak the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RiwayatPajak::findOne($id)) !== null) {
            return $model;
        } else {
