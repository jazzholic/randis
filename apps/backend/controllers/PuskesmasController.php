...
use common\models\PuskesmasSearch;
...
/**
 * PuskesmasController implements the CRUD actions for Puskesmas model.
 */
class PuskesmasController extends Controller
{
    ...
    /**
     * Lists all Puskesmas models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new PuskesmasSearch();
    ...
    /**
     * Displays a single Puskesmas model.
     * @param string $id
     * @return mixed
     */
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> 'Tambah Puskesmas',
                    'content'=>'<span class="text-success">Data Puskesmas Berhasil Ditambahkan</span>',
                    'footer'=> Html::button('<i class="fa fa-close" aria-hidden="true"></i> Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->kode_puskesmas]);
            } else {
    ...
    /**
     * Updates an existing Puskesmas model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Puskesmas model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Puskesmas model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the Puskesmas model based on its primary key value.
    ...
    {
        if (($model = Puskesmas::findOne($id)) !== null) {
            return $model;
        } else {
