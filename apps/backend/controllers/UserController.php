                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            return Yii::$app->user->identity->level != 'bidang';
                        }
                    ],
                ],
            ],
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> 'Tambah User',
                    'content'=>'<span class="text-success">Data User Berhasil Ditambahkan</span>',
                    'footer'=> Html::button('<i class="fa fa-close" aria-hidden="true"></i> Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            ...
            if($request->isGet){
                return [
                    ...
                    'footer'=> Html::button('<i class="fa fa-times" aria-hidden="true"></i> Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                                Html::button('<i class="fa fa-check-square-o" aria-hidden="true"></i> Submit',['class'=>'btn btn-primary','type'=>"submit"])
                ];         
                ...
                return [
                    'forceReload'=>'#crud-datatable-pjax',
                    'title'=> 'Reset Password : '.$user->name,
                    'content'=>'<span class="text-red"><center>Password Baru Berhasil Dibuat</center></span>',
                ];    
            }else{
                 return [
                    'title'=> 'Reset Password : '.$user->name,
