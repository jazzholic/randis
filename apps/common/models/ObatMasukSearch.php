...
/**
 * ObatMasukSearch represents the model behind the search form about `common\models\ObatMasuk`.
 */
class ObatMasukSearch extends ObatMasuk
{
    ...
    {
        return [
            [['kode_transaksi', 'tanggal_masuk', 'kode_obat', 'created_date', 'nama_obat'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'kode_transaksi', $this->kode_transaksi])
            ->andFilterWhere(['like', 'obat.nama_obat', $this->nama_obat])
